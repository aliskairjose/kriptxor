...
let DashboardPage = class DashboardPage {
    ...
    ngOnInit() {
        this.dashboard.dashboard().subscribe(response => this.data = Object.assign({}, response.data));
    }
};
